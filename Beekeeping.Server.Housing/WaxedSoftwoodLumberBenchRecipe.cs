...
[Ecopedia("Housing Objects", "Seating", false, true, "Waxed Softwood LumberBench Item")]
public class WaxedSoftwoodLumberBenchRecipe : Recipe
{
	public WaxedSoftwoodLumberBenchRecipe()
	{
		...
		CraftingComponent.AddTagProduct(typeof(SawmillObject), typeof(WaxedLumberBenchRecipe), new Recipe("Waxed Lumber Bench", Localizer.DoStr("Waxed Lumber Bench"), (IngredientElement[])(object)new IngredientElement[2]
		{
